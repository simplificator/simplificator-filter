...
Assume you have a product model with name:string, price:integer and available_at:date as attributes. Then you could define the following filter definition in your product class.
<pre>
